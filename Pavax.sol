...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 22000 * (10**9); // user must hold 22000 token
...
contract PEAKAVAX is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Peak AVAX";
    string constant _symbol = "PEAKAVAX";
